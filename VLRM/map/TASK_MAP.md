...
- t110: **The Great Cleansing** (Archiving old roadmaps/tasks) — DONE
- t111: VAVIMA Activation (Formalize routing to TASPIT) — ACTIVE
- t112: Subtree Synchronization Wave (Push Phase 8.0 to satellites) — PENDING
- t113: Materialize Larpat (LRPT) Seed — DONE
- t114: Materialize Vilami (VLRM) Seed — DONE
- t115: Materialize Radriloniuma (Gov) Seed — DONE
- t116: Transform RADRILONIUMA-PROJECT into pure Nexus — DONE
