...
- [x] Materialize Larpat (LRPT) from devkit/ (DONE 2026-02-20).
...
- [x] **The Great Cleansing:** Fixed environment drift and seeded initial organs (DONE 2026-02-20).
...
- [x] 2026-02-16 — governance: phase33717731 remediation r3+r4 completed (`phase33717731-r3-r4-autopilot-protocol-compliance-and-pointer-sync`); watchdog/cadence tuple verified GREEN, missing metrics (`last_drift_gate_utc`, `active-open-closure-gates`) restored, pointers synchronized, next step r5.
